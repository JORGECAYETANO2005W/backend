...
cloudinary.config({
  ...
  api_key: "565769936813723",
  api_secret: "vA1ghOTqWbOoVR64Z8wjOJc6caY",
});
...
export const getProducts = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Hubo un fallo al obtener productos" });
  }
};
...
export const createProduct = async (req, res) => {
  try {
    ...
    const { name, description, price, stock, images, category, marca } =
      req.body;
